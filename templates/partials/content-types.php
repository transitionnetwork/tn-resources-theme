<div class="flex items-center flex-wrap">
  ...
  <?php foreach($terms as $term) { ?>
    <div class="pr-2"><a class="no-underline flex items-center space-x-1 text-sm" href="<?php echo get_term_link($term); ?>"><img src="<?php echo get_field('term_icon', 'term_' . $term->term_id)['sizes']['thumbnail']; ?>" class="h-3 w-auto"><span><?php echo $term->name; ?></span></a></div>
  <?php } ?>
