<div class="bg-gray-200 py-24 relative">
  ...
  <?php if($background_image) { ?>
    <?php echo wp_get_attachment_image( $background_image['id'], 'full', false, array('class' => 'w-full h-full object-cover absolute inset-0') ); ?>
  <?php } ?>
    ...
    <div class="max-w-3xl">
      <div class="bg-white rounded-md outline-gray-300 outline-1 p-12 space-y-8">
        ...
        <form class="flex space-x-2">
          ...
          <input type="submit" value="Browse All" class="tn-btn tn-btn-primary"/>
