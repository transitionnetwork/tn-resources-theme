<div class="col-span-6 md:col-span-4 xl:col-span-2 flex items-stretch">
  <a href="<?php echo get_term_link($args->term_id); ?>" class="tn-card text-center p-6 no-underline text-gray-700 space-y-2 hover:bg-gray-50 hover:underline flex items-center justify-center flex-col">
