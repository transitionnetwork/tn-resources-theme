...
<header class="bg-white <?php echo m\menu_sticky(); ?>">
  <nav class="w-full py-4 justify-between flex container">
    ...
    <button class="flex items-center xl:hidden js-menu-toggle z-50" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
      <!-- Hamburger Icon -->
      <span class="w-6 h-6">
    ...
    <div class="fixed inset-0 hidden w-full h-screen bg-white xl:h-auto xl:relative xl:w-auto xl:flex xl:items-center z-20" id="main-menu">
      <?php
      if (has_nav_menu('header_navigation')) :
        wp_nav_menu([
          ...
          'container_class' => '',
          'container_id'    => '',
          'menu_class'      => 'navbar-nav flex justify-center items-center w-full h-full xl:space-x-6 flex-col xl:flex-row text-center px-4 xl:px-0',
